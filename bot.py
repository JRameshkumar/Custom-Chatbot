...
def main():
    ...
    # --- Header ---
    st.html("""<h5 style="text-align: center; color: #c27115;"> <i>This Application is still under Progress.. Stay Tune.. Few more features will be added<i/> </h5>""")
    
    st.html("""<h1 style="text-align: center; color:#1577c2;">🤖 <i>Custom Chat BoT</i> 💬</h1>""")
